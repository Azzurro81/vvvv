...
import { ASYLUM_CATEGORIES, ASYLUM_LAWS, isLawUnread } from '../../../constants/asylum_laws';

export default function CategoryLawsScreen() {
          ...
          renderItem={({ item }) => {
             ...
             return (
               <TouchableOpacity 
                  ...
                  onPress={() => (router.push as any)(`/asilo/law/${item.id}`)}
               >
