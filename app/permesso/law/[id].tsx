...
export default function PermessoLawDetailScreen() {
  ...
  const law = RESIDENCE_LAWS.find(l => l.id === id);
  ...
  if (!law) {
    return <View style={styles.container}><Text style={{padding: 20}}>Guida non trovata</Text></View>;
  }
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Guida Dettagliata' }} />
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={true}>
        ...
        <View style={styles.contentPadding}>
            <View style={styles.refBox}>
                <Ionicons name="documents-outline" size={20} color="#0369a1" />
            ...
            <Text style={styles.sectionTitle}>Requisiti Necessari</Text>
            ...
            {law.whereToApply && (
            <>
                <Text style={styles.sectionTitle}>Dove Andare</Text>
            ...
            <Text style={styles.sectionTitle}>Validità e Ricevuta</Text>
            <View style={styles.durationBox}>
                <Ionicons name="shield-checkmark-outline" size={22} color="#ea580c" style={{marginTop: 2}}/>
