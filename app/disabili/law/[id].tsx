...
import { DISABLED_LAWS, markLawAsRead } from '../../../constants/disabled_laws';
import { Ionicons } from '@expo/vector-icons';
import DocumentAccordion from '../../../components/DocumentAccordion';

import { useTranslatedLaw } from '../../../hooks/useTranslatedLaw';

export default function DisabiliLawDetailScreen() {
  const { id } = useLocalSearchParams();
  const initialLaw = DISABLED_LAWS.find(l => l.id === id);
  ...
  return (
    <>
      <Stack.Screen options={{ title: isLoading ? 'Caricamento...' : 'Dettaglio Disabilità' }} />
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={true}>
        ...
        <View style={styles.contentPadding}>
            ...
            <Text style={styles.sectionTitle}>Requisiti Adempimento</Text>
            ...
            {law.whereToApply && (
            <>
                <Text style={styles.sectionTitle}>Modalità di Presentazione</Text>
            ...
            <Text style={styles.sectionTitle}>Durata / Frequenza</Text>
