...
import { DISABLED_CATEGORIES, categoryHasUnreadNews } from '../../constants/disabled_laws';

export default function DisabiliFoldersScreen() {
    const router = useRouter();
    const [cats] = useState(DISABLED_CATEGORIES);
    ...
    return (
       <>
           <Stack.Screen options={{ title: 'Supporto Disabilità' }} />
           <ScrollView style={styles.container} contentContainerStyle={styles.listContent}>
           <Text style={styles.sectionTitle}>Guida all'invalidità e accessibilità</Text>
              ...
              {cats.map(cat => {
                 ...
                 return (
                    <TouchableOpacity 
                       key={cat.id} 
                       style={styles.card} 
                       onPress={() => (router.push as any)(`/disabili/category/${cat.id}`)}
                    >
                       {hasNovelty && (
