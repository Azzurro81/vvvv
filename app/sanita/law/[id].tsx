...
import { SANITA_LAWS, markLawAsRead } from '../../../constants/sanita_laws';
import { Ionicons } from '@expo/vector-icons';
import DocumentAccordion from '../../../components/DocumentAccordion';
import { useTranslatedLaw } from '../../../hooks/useTranslatedLaw';

export default function SanitaLawDetailScreen() {
  const { id } = useLocalSearchParams();
  const initialLaw = SANITA_LAWS.find(l => l.id === id);
  ...
  return (
    <>
      <Stack.Screen options={{ title: isLoading ? 'Caricamento...' : 'Dettaglio Sanità' }} />
