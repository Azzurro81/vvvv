...
import { DIGITAL_CATEGORIES, categoryHasUnreadNews } from '../../constants/digital_laws';

export default function DigitalFoldersScreen() {
    const router = useRouter();
    const [cats] = useState(DIGITAL_CATEGORIES);
    ...
    return (
       <>
           <Stack.Screen options={{ title: 'Burocrazia Digitale' }} />
           <ScrollView style={styles.container} contentContainerStyle={styles.listContent}>
           <Text style={styles.sectionTitle}>Semplifica la tua identità digitale</Text>
              ...
              {cats.map(cat => {
                 ...
                 return (
                    <TouchableOpacity 
                       key={cat.id} 
                       style={styles.card} 
                       onPress={() => (router.push as any)(`/digital/category/${cat.id}`)}
                    >
                       {hasNovelty && (
