...
import { DIGITAL_LAWS, markLawAsRead } from '../../../constants/digital_laws';
import { Ionicons } from '@expo/vector-icons';
import DocumentAccordion from '../../../components/DocumentAccordion';

import { useTranslatedLaw } from '../../../hooks/useTranslatedLaw';

export default function DigitalLawDetailScreen() {
  const { id } = useLocalSearchParams();
  const initialLaw = DIGITAL_LAWS.find(l => l.id === id);
  ...
  return (
    <>
      <Stack.Screen options={{ title: isLoading ? 'Caricamento...' : 'Dettaglio Guida' }} />
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={true}>
        ...
        <View style={styles.contentPadding}>
            ...
            {law.documentsNeeded && (
            <>
                <Text style={styles.sectionTitle}>Documentazione Necessaria</Text>
            ...
            {law.whereToApply && (
            <>
                <Text style={styles.sectionTitle}>Dove e Come</Text>
