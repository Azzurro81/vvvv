...
import { LONG_TERM_CATEGORIES, LONG_TERM_LAWS, isLawUnread } from '../../../constants/long_term_laws';

export default function CartaCategoryLawsScreen() {
          ...
          renderItem={({ item }) => {
             ...
             return (
               <TouchableOpacity 
                  ...
                  onPress={() => (router.push as any)(`/carta/law/${item.id}`)}
               >
