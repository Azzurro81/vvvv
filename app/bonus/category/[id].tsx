...
import { BONUS_CATEGORIES, BONUS_LAWS, isLawUnread } from '../../../constants/bonus_laws';

export default function BonusCategoryLawsScreen() {
  ...
  const laws = id === 'novita' ? BONUS_LAWS.filter(l => l.isNew) : BONUS_LAWS.filter(l => l.categoryId === id);
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        <FlatList
          ...
          renderItem={({ item }) => {
             ...
             return (
               <TouchableOpacity 
                  ...
                  onPress={() => (router.push as any)(`/bonus/law/${item.id}`)}
               >
          ...
          ListEmptyComponent={() => (
             <Text style={styles.emptyText}>Nessun bonus disponibile.</Text>
          )}
        />
      </SafeAreaView>
    </>
