...
import { FAMILY_CATEGORIES, FAMILY_LAWS, isLawUnread } from '../../../constants/family_laws';

export default function FamigliaCategoryLawsScreen() {
          ...
          renderItem={({ item }) => {
             ...
             return (
               <TouchableOpacity 
                  ...
                  onPress={() => (router.push as any)(`/famiglia/law/${item.id}`)}
               >
