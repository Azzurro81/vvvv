...
import { FAMILY_CATEGORIES, categoryHasUnreadNews } from '../../constants/family_laws';

export default function FamigliaFoldersScreen() {
    const router = useRouter();
    const [cats] = useState(FAMILY_CATEGORIES);
    ...
    return (
       <>
           <Stack.Screen options={{ title: 'Famiglia e Casa' }} />
           <ScrollView style={styles.container} contentContainerStyle={styles.listContent}>
           <Text style={styles.sectionTitle}>Scegli la tipologia di pratica familiare</Text>
              ...
              {cats.map(cat => {
                 ...
                 return (
                    <TouchableOpacity 
                       key={cat.id} 
                       style={styles.card} 
                       onPress={() => (router.push as any)(`/famiglia/category/${cat.id}`)}
                    >
                       {hasNovelty && (
