...
import { FAMILY_LAWS, markLawAsRead } from '../../../constants/family_laws';
import { Ionicons } from '@expo/vector-icons';
import DocumentAccordion from '../../../components/DocumentAccordion';

import { useTranslatedLaw } from '../../../hooks/useTranslatedLaw';

export default function FamigliaLawDetailScreen() {
  const { id } = useLocalSearchParams();
  const initialLaw = FAMILY_LAWS.find(l => l.id === id);
    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={true}>
        ...
        <View style={styles.contentPadding}>
            ...
            <Text style={styles.sectionTitle}>Requisiti di Base</Text>
            ...
            {law.documentsNeeded && (
            <>
                <Text style={styles.sectionTitle}>Documentazione da Allegare</Text>
            ...
            {law.whereToApply && (
            <>
                <Text style={styles.sectionTitle}>Dove Inoltrare la Domanda</Text>
            ...
            <Text style={styles.sectionTitle}>Validità Temporale</Text>
