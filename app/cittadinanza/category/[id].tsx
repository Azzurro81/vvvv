...
import { CITIZENSHIP_CATEGORIES, CITIZENSHIP_LAWS, isLawUnread } from '../../../constants/citizenship_laws';

export default function CittadinanzaCategoryLawsScreen() {
          ...
          renderItem={({ item }) => {
             ...
             return (
               <TouchableOpacity 
                  ...
                  onPress={() => (router.push as any)(`/cittadinanza/law/${item.id}`)}
               >
